...
Lets look at each part of the query to understand what happens where.
...
multiple logic vars. Here we wrap the output in an extra vector that
Cascalog will consume.
