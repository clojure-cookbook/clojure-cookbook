...
Now, add the `[cascalog/cascalog-more-taps "2.0.0"]` dependency to the
+:dependencies+ vector of your _project.clj_ and set the
+cookbook.aggregation+ namespace to be AOT-compiled. Your
_project.clj_ should look like this:
