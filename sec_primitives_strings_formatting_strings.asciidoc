...
for a float. Beyond specifiers for strings, integers and flaots, there are specifiers for characters, dates, and numbers of different bases (octal, hexadecimal) to name a few.
...
Visit http://docs.oracle.com/javase/1.5.0/docs/api/java/util/Formatter.html[java.util.Formatter] to learn more about formatting strngs.
**** 
