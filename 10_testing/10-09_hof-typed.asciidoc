...
feedback: compile time.(((core.typed system, checking higher-order functions with)))(((higher-order functions)))
...
* The +core.typed+ user guide, in particular its sections on
  http://bit.ly/core-typed-poly[polymorphism]
  and
  http://bit.ly/core-typed-fns[function
  annotations]
