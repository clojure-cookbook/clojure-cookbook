...
----
;; Match against this mock when the argument is a list which contains 3 specific elements
(provided
  (http/get (contains [1,2,3])) => :result)

;; Match against a single argument or any value
(provided
