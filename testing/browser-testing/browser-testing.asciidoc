...
This test is very basic. In most real tests, you'll load a URL, perform an action, and verify that the application behaved as expected. Write another test that interacts with the page:
