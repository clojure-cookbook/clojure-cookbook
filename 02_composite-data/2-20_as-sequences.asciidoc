...
To create a map *from* a sequence, you can exploit the fact that(((functions, conj)))(((functions, into)))
...
It is also possible to construct a map from *two* sequences: one(((functions, zipmap)))
