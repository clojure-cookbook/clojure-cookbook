...
You have a sequence of elements and want to remove any duplicates,(((collections, removing duplicate elements)))
while possibly preserving the order of elements.((("duplicates, removing")))((("elements, removing duplicate")))

==== Solution

When the sequence of elements you're working with is of a bounded,(((funtions, set)))(((funtions, distinct)))
...
slowest, while simply calling `set` is about two times faster.
