...
which can be tested for membership quickly.((("composite data", "sets", id="ix_CDset", range="startofrange")))(((sets, creating)))(((functions, hash-set)))(((funtions, set)))
...
result in a runtime error.(((exceptions/errors, with sorted sets)))(((runtime errors, with sorted sets)))
