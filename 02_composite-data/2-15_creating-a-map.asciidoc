...
These are backed by a simple array. These are efficient for very small maps, but not for larger sizes.(((array maps)))((("Clojure", "clojure.lang.PersistentArrayMap")))
