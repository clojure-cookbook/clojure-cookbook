...
should be sorted before the second argument.(((natural ordering)))
...
The compare function may be called an arbitrary number of times as the sort is evaluated.
...
http://docs.oracle.com/javase/7/docs/api/java/lang/Comparable.html[+java.lang.Comparable+]
...
http://docs.oracle.com/javase/7/docs/api/java/util/Comparator.html[+java.util.Comparator+]
