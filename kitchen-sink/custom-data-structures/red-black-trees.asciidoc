...
Start by defining the helper functions in terms of which our Red Black Tree type will be implemented:
...
Next, write the protocols and data type which will act as delegates to the functions above:
...
Finally, you can use the new data structure at the REPL:
