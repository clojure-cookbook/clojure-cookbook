...
If you never use ZSH pattern matching while starting Leiningen, you can solve the problem more permanently by setting up an alias with +noglob+ in your .zshrc file. Afterward, the +noglob+ option will be used every time you call +lein+.
