...
You want to run a Clojure application as a _daemon_ (i.e., you want your application to run in the background) in another system process.
...
tunes, and Daemon is one such "old tune."
