...
Use the https://github.com/clojurewerkz/cassaforte[Cassaforte] library for connecting to Cassandra cluster and work with the records in the database.
...
Include the Cassaforte dependency in your +project.clj+:
...
There's much more to Cassandra than just creating tables and inserting values. If you want to update records in your database, you cancall the +update+ function:
