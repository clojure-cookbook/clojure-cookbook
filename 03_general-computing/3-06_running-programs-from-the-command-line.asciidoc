...
You want to invoke your Clojure application from the command line.((("development ecosystem", "command line invocation")))(((command lines, running programs from)))(((lein run)))(((Leiningen plugins)))
