...
arguments passed to them.(((functions, with polymorphic behavior)))(((polymorphic behaviors)))(((geometric functions)))(((functions, cond)))(((functions, condp)))
...
hard to understand at face value how each should be used.(((types, vs. records)))(((records vs. types)))
