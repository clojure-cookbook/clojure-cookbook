...
From a REPL, you want to read documentation for a function.((("REPL (read-eval-print loop)", "interactive documenation")))(((interactive documentation)))((("documentation, interactive")))((("development ecosystem", "interactive documentation")))(((doc macro)))(((macros, doc)))
