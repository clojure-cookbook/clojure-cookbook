...
_Mappings_ define the fields in a document what the indexing
characteristics are each field. Mapping types are specified when
...
a lot of ElasticSearch functionality.
