...
writing SQL by hand.(((SQL databases, querying with Korma)))(((Korma)))(((queries)))
...
SQL, packaged in a readable, Clojure-based DSL.(((entitites)))((("DDL (Data Definition Language)")))(((macros, defentity)))(((defentity macro)))
