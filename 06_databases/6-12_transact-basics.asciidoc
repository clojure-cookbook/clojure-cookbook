...
To follow along with this recipe, first complete the steps in the solutions to <<sec_datomic_connect_to_datomic>>, and
<<sec_datomic_schema>>.
...
;; This code assumes you have already run the examples from "Connecting to a Datomic Database" and
