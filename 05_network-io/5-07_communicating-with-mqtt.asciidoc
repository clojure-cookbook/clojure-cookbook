...
`SNControl/+/device1`::
Any +device1+ in states under domain +SNControl+ (e.g., +SNControl/Florida/device1+ and +SNControl/California/device1+) will match.

`SNControl/+/+/sensor1`::
Will match +SNControl/Florida/device1/sensor1+ and +SNControl/Florida/device2/sensor1+.
