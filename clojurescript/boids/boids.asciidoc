...
Before looking at the whole version, try building a minimal viabale solution to see the
...
use of http://d3js.org/[D3.js] from ClojureScript. Here, 5 objects were put in a
vector wrapped by an atom to represent the boids, and then D3's timer
function was used to repeatedly update and rerender these objects. Before getting too
