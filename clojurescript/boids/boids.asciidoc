...
You can use the https://github.com/dribnet/strokes[Strokes library] to employ D3 from ClojureScript.
...
allows for idiomatic usage of http://d3js.org/[D3.js] from
ClojureScript. Here, five objects were put in a vector wrapped by an atom
...
Finally, take a look at the full version, which has the same basic structure, but which
