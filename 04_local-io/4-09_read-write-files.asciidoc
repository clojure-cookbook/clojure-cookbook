...
* The documentation for http://bit.ly/javadoc-reader[+java.io.Reader+], http://docs.oracle.com/javase/7/docs/api/java/io/Writer.html[+java.io.Writer+], and http://docs.oracle.com/javase/7/docs/api/java/io/Writer.html[+java.io.Writer+]
