...
library, see the http://docs.oracle.com/javase/7/docs/api/java/nio/package-summary.html,http:/bit.ly/javadoc-nio[Java NIO documentation] or pass:[<emphasis><ulink role="orm:hideurl" url="http://shop.oreilly.com/product/9780596002886.do">Java NIO</ulink></emphasis>] by Ron Hitchens (O'Reilly).
