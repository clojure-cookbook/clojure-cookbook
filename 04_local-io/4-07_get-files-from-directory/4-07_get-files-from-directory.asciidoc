...
* Combine these techniques with utility libraries like Google Guava's http://bit.ly/guava-files[+Files+ class] or Apache Commons http://bit.ly/1beaLoM[+FilenameUtils+ class] to exert even greater leverage over the file sequence abstraction.
