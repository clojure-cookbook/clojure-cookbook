...
The JVM's built-in time and date classes do work well with the notion of time zones; +Date+ treats every value as UTC, and +Calendar+ is cumbersome to work with in Clojure. Use https://github.com/clj-time/clj-time[clj-time] to properly deal with time zones.
