...
Visit the API documentation for http://docs.oracle.com/javase/7/docs/api/java/util/Formatter.html[+java.util.Formatter+] to learn more about formatting strings.
****
