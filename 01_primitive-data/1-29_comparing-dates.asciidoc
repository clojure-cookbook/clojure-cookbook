...
You need to compare one date to another, or you need to sort a sequence of dates.((("dates/times", "comparing/sorting")))(((comparisons, of Java Dates)))(((functions, compare)))(((sorting, dates/times)))

==== Solution

You can compare Java pass:[<literal>Date</literal>s] using the +compare+ function:
...
arguments to numerical types.(((Clojure, built-in comparison operators)))((("Clojure", "clojure.lang.Numbers")))
...
less than (-1), equal to (0), or greater than (+1) the second argument.(((functions, compare)))(((functions, sort)))
...
have to coerce them to one uniform type using the functions in +clj-time.coerce+.(((Joda-Time library)))
