...
You need represent instances of time in a readable and serializable form.((("dates/times", "representing as literals")))((("#inst literals")))
...
implementations in the works.(((reader literals)))(((extensible data notation (edn)")))
